...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(LED_live_pulse_GPIO_Port, LED_live_pulse_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_3_Pin|I_3X_Pin|LED_1_Pin|LED_2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : LED_live_pulse_Pin */
  GPIO_InitStruct.Pin = LED_live_pulse_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_live_pulse_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_3_Pin I_3X_Pin LED_1_Pin LED_2_Pin */
  GPIO_InitStruct.Pin = LED_3_Pin|I_3X_Pin|LED_1_Pin|LED_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
